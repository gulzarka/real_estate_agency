# Generated by Django 2.2.24 on 2023-05-19 02:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_building', models.BooleanField(blank=True, db_index=True, null=True, verbose_name='Новое ли здание')),
                ('liked_by', models.ManyToManyField(related_name='likes_flat', to=settings.AUTH_USER_MODEL, verbose_name='кто лайкнул')),
            ],
        ),
        migrations.CreateModel(
            name='Owner',
